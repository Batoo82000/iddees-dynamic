...
class AProposCrudController extends AbstractCrudController
{
    ...
    {
        return $crud
            ->setPageTitle('index', 'Gestion de la page "À propos"')
            ->setPageTitle('edit', 'Modification de la page "À propos"')
            ->setPageTitle('new', 'Ajout d\'une page "À propos"');
    }
    ...
    public function configureFields(string $pageName): iterable
    {
        return [
            IdField::new('id')
                ->hideOnForm()
                ->hideOnIndex(),
            TextEditorField::new('content', 'Contenu de "À propos" (obligatoire) :')
                ->setRequired(true),
        ];
    }
