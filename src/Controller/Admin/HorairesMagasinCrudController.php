...
class HorairesMagasinCrudController extends AbstractCrudController
{
    public static function getEntityFqcn(): string
    {
        return HorairesMagasin::class;
    }

    public function configureCrud(Crud $crud): Crud
    {
        return $crud
            ->setPageTitle('index', 'Gestion des horaires pour le magasin')
            ->setPageTitle('edit', 'Modification de la plage horaire : magasin')
            ->setPageTitle('new', 'Création d\'une plage horaire : magasin');
    }
