...
#[AllowDynamicProperties] class BlogController extends AbstractController
{
    ...
    public function index(Request $request): Response
    {
        ...
        } else { // Si le formulaire n'a pas été soumis ou n'est pas valide, cela signifie que l'utilisateur n'a pas encore soumis de formulaire ou que les données soumises ne sont pas valides. Dans ce cas, tous les blogs sont récupérés en utilisant la méthode findAll() de l'objet BlogsRepository.
